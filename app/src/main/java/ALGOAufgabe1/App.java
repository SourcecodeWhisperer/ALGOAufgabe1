...
public class App {
    ...
    static private String buildCLIMenu(LinkedList<ICommand> commands) {
        ...
        builder.append("Console-Application: Exercise-1 \t <Nasiem> <Ziad> <0575302>" + System.lineSeparator());
        builder.append(System.lineSeparator());
    ...
    static private ICommand selectCommand(LinkedList<ICommand> commands) {
        do {
            int select = Console.readIntegerFromStdIn("Please select an option:",1);
